...
urlpatterns = [
		...
		url(r'^add-post/(?P<project>\d+)/(?P<topic>\d+)/$', AddPostView.as_view(), name='add_post'),
		...
		url(r'^delete-post-location/(?P<pk>\d+)/$', views.delete_post_location, name='delete_post_location'),
